      ...
      var myChart = new Chart(myCanvas, {
        ...
        data: {
          ...
          datasets: [{
            ...
            data: [35, 25, 40, 15, 30, 25, 45],
            cubicInterpolationMode: 'monotone',
            tension: 0.4,
            backgroundColor: ['rgba(355, 33, 0, 0.8)'],
            borderColor: ['rgba(355, 33, 0, 0.8)'],
            borderWidth: 2
          }, {
            label: 'Total User',
            data: [20, 35, 20, 45, 55, 35, 10],
            cubicInterpolationMode: 'monotone',
            tension: 0.4,
            backgroundColor: ['rgba(135, 12, 0, 1)'],
            borderColor: ['rgba(135, 12, 0, 1)'],
            borderWidth: 2
          }]
        },
        options: {
